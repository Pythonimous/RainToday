...
def test_rain_endpoint_valid_params(monkeypatch):
    ...
    response = client.get("/rain", params={"lat": 40.7128, "lon": -74.0060, "horizon": 3})
...
def test_rain_endpoint_matches_geoapi():
    ...
    lat, lon, horizon = 40.7128, -74.0060, 3
    ...
    response = client.get("/rain", params={"lat": lat, "lon": lon, "horizon": horizon})
    assert response.status_code == 200
